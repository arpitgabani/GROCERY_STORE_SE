                                    ...
                                    <td class="invert">
                                         <div class="quantity"> 
                                            <div class="quantity-select">                           
                                                <div class="entry value-minus" id="minus_<?= $pid ?>" data-id="<?=$pid?>">&nbsp;</div>
                                                <div class="entry value">
                                                    <span id="quentity_<?= $pid ?>"><?=$product['quantity']?></span>
                                                </div>
                                                <div class="entry value-plus active" id="plus_<?= $pid ?>" data-id="<?= $pid ?>">&nbsp;</div>
                                            </div>
                                        </div>
                                    </td>
