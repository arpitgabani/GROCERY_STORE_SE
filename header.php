      ...
      <div class="container">
        ...
        <div class="w3ls_logo_products_left1">
          <ul class="phone_email">
            <li><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+919999988888">(+91) 9999988888</a></li>
            <li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:sgpproject@gmail.com"> <a href="mailto:sgpproject@gmail.com">sgpproject@gmail.com</a></li>
          </ul>
        </div>
        <div class="clearfix"></div>
      </div>
