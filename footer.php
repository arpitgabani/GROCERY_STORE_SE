			...
			<div class="col-md-4 w3_footer_grid">
				...
				<ul class="w3_footer_grid_list1">
                    ...
                    <ul class="phone_email">
                        <li><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+919979331605">(+91) 9999988888</a></li>
                        <li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:sgpproject@gmail.com">sgpproject@gmail.com</a></li>
				    </ul>
				</ul>
			</div>
